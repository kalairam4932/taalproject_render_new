...
const RHtable = () => {
  ...
  // const [toggledClearRows, setToggleClearRows] = React.useState(false);
    ...
    const fetchUsers = async () => {
        const response = await axios.get(`${base_url}/api/Engine/getLHENGINEDATA`);
    ...
    const dldRHTABLE = async ({deleteid}) => {
        ...
        const response = await axios.delete(`${base_url}/api/Engine/dldLHENGINEDATA/${deleteid}`);
        return response.data;
    };  
  ...
  return (
    <div >
            ...
            <div className="d-flex justify-content-between align-items-center mb-1 mt-3  p-2 rounded shadow bg-card-color ">
                <h5 className="text-white fw-bold">LH Engine List</h5>
                <div>
                    <button className="btn btn-primary me-2" onClick={()=>navigated('/LHENGINE')}>Add New</button>
